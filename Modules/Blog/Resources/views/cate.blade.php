...
@section('titlePage', 'Danh mục	')
@section('content')

	<section class="content">
		<div class="row">
			<form role="form" method="POST" action="{{ route('admin::blog::category::add') }}">
					...
					<div class="box box-default">
					  <div class="box-header with-border">
					      	...
					      	{{-- tiếng việt --}}
					      	  <div class="tab-pane active" id="vi">
					      	    ...
					      	    <div class="form-group">
					      	      ...
					      	      <p class="help-block">Chuỗi này bao gồm chữ cái thường, số và dấu gạch ngang (-). Có thể điền giống tên tiêu đề.</p>
					      	    </div>
					    ...
					    <div class="box-footer">
					    	<button class="btn btn-block btn-primary"><i class="fa fa-plus"></i> Thêm danh mục</button>
					    </div>
					</div>
				</div>
			</form>
				    	  ...
				    	  <div class="box-body">
				    	    <table id="list" class="table table-bordered table-striped">
				    	      ...
				    	      <tbody>
					    	      ...
					    	      <tr>
					    	      <td>{{ $stt++ }}</td>
					    	        <td class="maxsize">{{ $category->title }}</td>
					    	        <td class="maxsize">{{ $category->description }}</td>
					    	        <td>
					    	        	@if( $category->status )
					    	        ...
					    	        <td>
					    	        	<div class="btn-group">
					    	        			{{-- <a href="#"> --}}
					    	        			<?php $cateEn = DB::table('blog_category_translations')->where('cate_id', $category->cate_id)->first(); ?>
					    	        			...
					    	        			{{-- </a> --}}
					    	        		  	<a href="{!! URL::route('admin::blog::category::delete', $category->cate_id) !!}">
		...
		<script type="text/javascript">
			document.addEventListener("DOMContentLoaded", function(event) {
				...
				$('#titleVi').focusout(function() {
					$('#vi').find("input[name='slug']").val(ChangeToSlug($(this).val()));
				});
