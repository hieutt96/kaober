<div id="signup" class="modal">
  ...
  <div class="modal-resize modal-content">
	          		...
	          		<div class="field">
	          		  <p class="control">
	          		    <label class="checkbox">
	          		      <input type="checkbox">
	          		      	<span  class="subtitle is-5">Nhớ mật khẩu</span>
	          		    </label>
	          		  </p>
	          		</div>
	          	</div>
          		<div class="column is-4">
          			<p class="subtitle is-5" style="float: right;" id="resetpassword"><a>Quên mật khẩu?</a></p>
          		</div>
          	</div>
          ...
          <div class="block">
          		<button class="button is-danger is-large is-fullwidth" style="background-color: #ff5a5f;"> Đăng nhập
          		</button>
          </div>
          ...
          <hr>
      		...
      		<div class="columns">
      			<div class="column is-9">
      				<p class="title is-5 is-spaced">Chưa có tài khoản ?</p>
      			</div>
      			<div class="column is-3">
      				<button class="button is-primary is-outlined" style="float: right" id="signupget">Đăng ký</button>
      			</div>
      		</div>
  		</div>
	</div>
